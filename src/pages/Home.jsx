  ...
  return (
    <div className="min-h-screen">
      ...
      <a
        ...
        className="fixed bottom-6 right-6 z-50 bg-[#20B597] hover:bg-[#179B7E] text-white p-4 rounded-full shadow-lg transition-all duration-300 hover:scale-110"
      >
        ...
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          ...
          >
            ...
            >
              ...
              <br />
              <span className="bg-gradient-to-r from-[#20B597] to-[#34A7E0] bg-clip-text text-transparent drop-shadow-2xl">
            ...
            <motion.p
              ...
              className="text-xl md:text-2xl mb-4 text-[#DEDEF0] max-w-3xl mx-auto leading-relaxed"
            >
            ...
            <motion.p
              ...
              className="text-lg mb-12 text-[#BCBEE6] max-w-2xl mx-auto"
            >
            ...
            >
              ...
              <Link
                to="/products"
                className="group relative px-8 py-4 rounded-xl text-lg font-semibold overflow-hidden transition-all duration-300 hover:scale-105 hover:shadow-2xl hover:shadow-[#20B597]/50"
              >
                <div className="absolute inset-0 bg-gradient-to-r from-[#20B597] to-[#34A7E0] transition-all duration-300 group-hover:scale-110"></div>
                <div className="absolute inset-0 bg-gradient-to-r from-[#20B597] to-[#34A7E0] opacity-0 group-hover:opacity-100 transition-opacity duration-300 blur-xl"></div>
            ...
            <motion.div
              ...
              className="mt-16 flex flex-wrap justify-center items-center gap-8 text-[#BCBEE6]"
            >
              <div className="flex items-center gap-2">
                <svg className="w-5 h-5 text-[#20B597]" fill="currentColor" viewBox="0 0 20 20">
        ...
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            <h2 className="text-3xl md:text-5xl font-bold text-gray-900 mb-6">
              About <span className="text-primary-500">VaradBuilds</span>
            </h2>
          </motion.div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            <h2 className="text-3xl md:text-5xl font-bold text-gray-900 mb-4">
              Why Choose <span className="text-primary-500">Bizgurukul</span>?
            </h2>
      ...
      {/* Final CTA Section */}
      <section className="relative py-20 h-400 bg-gradient-to-br from-[#2D2E84] via-[#383AB4] to-[#1A1B5C] overflow-hidden">
        {/* Animated Background Elements */}
        <div className="absolute inset-0 overflow-hidden pointer-events-none">
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center relative z-10">
          ...
          >
            <h2 className="text-4xl md:text-6xl font-bold text-white mb-6">
              Ready to Start Your
              <br />
              <span className="bg-gradient-to-r from-[#20B597] to-[#34A7E0] bg-clip-text text-transparent">
                Digital Journey?
              </span>
            </h2>
            <p className="text-xl text-[#DEDEF0] mb-10 max-w-2xl mx-auto leading-relaxed">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center items-center">
              ...
              <Link
                to="/products"
                className="group relative px-10 py-4 rounded-xl text-lg font-bold overflow-hidden transition-all duration-300 hover:scale-105 hover:shadow-2xl hover:shadow-[#20B597]/50"
              >
                <div className="absolute inset-0 bg-gradient-to-r from-[#20B597] to-[#34A7E0] transition-all duration-300 group-hover:scale-110"></div>
                <div className="absolute inset-0 bg-gradient-to-r from-[#20B597] to-[#34A7E0] opacity-0 group-hover:opacity-100 transition-opacity duration-300 blur-xl"></div>

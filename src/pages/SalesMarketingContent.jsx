  ...
  return (
    <>
      ...
      <Section id="intro" number="1" title="Introduction 🚀">
        ...
        <div className="bg-indigo-50/60 rounded-xl p-4 border border-indigo-100 my-4">
        ...
        <p className="font-bold text-indigo-700 text-xl">You don't understand Sales and Marketing.</p>
      ...
      <Section id="what-marketing" number="2" title="What is Marketing? 📢">
        ...
        <div className="grid grid-cols-2 md:grid-cols-3 gap-3 my-4">
          {[
            ...
            <div key={item} className="bg-indigo-50/60 rounded-lg p-3 border border-primary-100 text-center text-sm font-medium text-gray-700">
              {item}
            </div>
          ))}
        </div>
        ...
        <div className="grid md:grid-cols-2 gap-3 my-4">
          {[
            ...
            <div key={item} className="flex items-center gap-2 bg-indigo-50/60 rounded-lg p-3 border border-primary-100">
              <span className="text-indigo-600 font-bold">✔</span>
      ...
      <Section id="what-sales" number="3" title="What is Sales? 💰">
        ...
        <div className="grid grid-cols-2 gap-3 my-4">
          {[
            ...
            <div key={item} className="bg-emerald-50 rounded-lg p-3 border border-emerald-100 text-center text-sm font-medium text-gray-700">
              {item}
            </div>
          ))}
        </div>
        ...
        <div className="grid md:grid-cols-2 gap-3 my-4">
          {[
            ...
            <div key={item} className="flex items-center gap-2 bg-emerald-50 rounded-lg p-3 border border-emerald-100">
      ...
      <Section id="difference" number="4" title="Difference Between Sales and Marketing 🔍">
        ...
        <div className="bg-indigo-50/60 rounded-xl p-5 border border-indigo-100 my-4 text-center">
        ...
        <div className="space-y-4 my-6">
          ...
          <div className="border-l-4 border-secondary-400 pl-4 py-2 bg-emerald-50 rounded-r-lg">
      ...
      <Section id="strategies" number="5" title="Student Strategies 🎯">
        ...
        <div className="bg-indigo-50/60 rounded-xl p-5 border border-indigo-100 mt-4">
          <p className="font-bold text-indigo-700 text-center">Consistency builds trust and authority.</p>
        </div>
      </Section>
      ...
      <Section id="daily-system" number="6" title="Daily 60 Minute System ⏰">
        ...
        <div className="space-y-4 my-6">
          {[
            ...
            <div key={time} className="flex gap-4 items-start bg-indigo-50/60 rounded-xl p-4 border border-indigo-100">
      ...
      <Section id="example" number="7" title="Engineering Student Example 🎓">
        ...
        <p className="font-semibold text-indigo-700 text-xl text-center my-4">Small daily actions → Big results.</p>

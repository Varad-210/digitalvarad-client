    ...
    <>
      ...
      <Section id="what-marketing" number="2" title="What is Marketing? 📢">
        ...
        <div className="bg-gradient-to-br from-primary-500 to-primary-700 text-white rounded-xl p-6 text-center">
          ...
          <p className="text-primary-100 mt-2">Without marketing, nobody knows you.</p>
        </div>
      </Section>
      ...
      <Section id="what-sales" number="3" title="What is Sales? 💰">
        ...
        <div className="grid grid-cols-2 gap-3 my-4">
          {[
            ...
            <div key={item} className="bg-secondary-50 rounded-lg p-3 border border-secondary-200 text-center text-sm font-medium text-gray-700">
              {item}
            </div>
          ))}
        </div>
        ...
        <div className="grid md:grid-cols-2 gap-3 my-4">
          {[
            ...
            <div key={item} className="flex items-center gap-2 bg-secondary-50 rounded-lg p-3 border border-secondary-200">
      ...
      <Section id="difference" number="4" title="Difference Between Sales and Marketing 🔍">
        ...
        <div className="space-y-4 my-6">
          ...
          <div className="border-l-4 border-secondary-400 pl-4 py-2 bg-secondary-50 rounded-r-lg">
        ...
        <div className="bg-gradient-to-br from-primary-500 to-primary-700 text-white rounded-xl p-6 text-center">
          ...
          <p className="text-primary-100">Marketing to attract audience + Sales to convert audience = Consistent online income</p>
        </div>
      </Section>

  ...
  return (
    <>
      ...
      <div className="min-h-screen" style={{ background: '#F8F9FE' }}>
        {/* ── Hero ── */}
        <section className="relative bg-gradient-to-br from-[#2D2E84] via-[#383AB4] to-[#1A1B5C] py-32 overflow-hidden text-white">
          ...
          <div className="absolute inset-0 overflow-hidden pointer-events-none">
            ...
            <div
              className="absolute bottom-10 right-5 w-80 h-80 bg-[#383AB4]/15 rounded-full blur-3xl animate-pulse"
              style={{ animationDelay: "1s" }}
            ></div>
            <div
              className="absolute top-1/3 right-1/4 w-72 h-72 bg-[#34A7E0]/15 rounded-full blur-3xl animate-pulse"
          ...
          <div className="max-w-4xl mx-auto px-4 sm:px-6 relative z-10">
            ...
            >
              ...
              <Link
                to="/blog"
                className="inline-flex items-center gap-2 text-sm font-medium text-white/70 hover:text-white mb-8 transition-colors group"
              >
              ...
              <div className="flex items-center gap-3 mb-5">
                <span
                  className={`inline-flex items-center gap-1.5 px-3 py-1 rounded-full text-xs font-bold uppercase tracking-wider ${cat.bg} ${cat.text}`}
                >
                  <span
              ...
              {/* Title */}
              <h1 className="text-3xl md:text-[2.75rem] font-extrabold leading-tight mb-4 tracking-tight">
                {post.title}
              </h1>
              ...
              <div className="flex items-center gap-4">
                ...
                <div className="w-10 h-10 rounded-full flex items-center justify-center text-white text-sm font-black shadow-lg bg-gradient-to-r from-cyan-400 to-emerald-400">
                  VS
                </div>

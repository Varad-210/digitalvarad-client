  ...
  return (
    <div className="min-h-screen">
      ...
      <section className="relative bg-gradient-to-br from-[#1e3a8a] via-[#2563eb] via-[#4338ca] to-[#0f172a] py-32 overflow-hidden">
        {/* Static Background Elements Instead of Framer Motion */}
        ...
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            <h2 className="text-3xl md:text-5xl font-bold text-gray-900 mb-6">
              About <span className="text-blue-600">VaradBuilds</span>
            </h2>
          </div>
          ...
          <div className="flex flex-col md:flex-row items-center gap-12">
            ...
            <div className="md:w-1/3 flex-shrink-0">
              <img
                ...
                className="w-full max-w-sm mx-auto rounded-2xl shadow-2xl border-4 border-blue-100"
              />
            </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            <h2 className="text-3xl md:text-5xl font-bold text-gray-900 mb-4">
              Why Choose <span className="text-blue-600">Bizgurukul</span>?
            </h2>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
            {benefits.map((benefit, index) => (
              <div
                key={benefit.title}
                className="bg-gradient-to-br from-blue-50 to-white p-8 rounded-xl shadow-lg hover:shadow-2xl transition-all duration-300 border border-blue-100"
              >
